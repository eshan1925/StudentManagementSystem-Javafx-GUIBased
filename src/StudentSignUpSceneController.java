...
public class StudentSignUpSceneController {
    ...
    void register(ActionEvent event) {
        ...
        if (a.equals("") || b.equals("") || c.equals("")) {
            ...
            try {
                if( d.equals("student123")){
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/student_db", "eshan",
                        "eventour2020");
                Statement s = con.createStatement();
                String s1 = "insert into students(username,password,name) values('" + a + "','" + b + "','" + c + "');";
                JOptionPane.showMessageDialog(null, "Registered new Student Successfully", "Login Success", 1);
